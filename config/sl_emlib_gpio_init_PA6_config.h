#ifndef SL_EMLIB_GPIO_INIT_PA6_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PA6_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PA6_MODE> Pin mode
...
// <gpio> SL_EMLIB_GPIO_INIT_PA6
// $[GPIO_SL_EMLIB_GPIO_INIT_PA6]
#define SL_EMLIB_GPIO_INIT_PA6_PORT              gpioPortA
#define SL_EMLIB_GPIO_INIT_PA6_PIN               6
// [GPIO_SL_EMLIB_GPIO_INIT_PA6]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PA6_CONFIG_H
