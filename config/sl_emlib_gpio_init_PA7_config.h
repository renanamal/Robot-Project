#ifndef SL_EMLIB_GPIO_INIT_PA7_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PA7_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PA7_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PA7_MODE        gpioModeInputPullFilter

// <o SL_EMLIB_GPIO_INIT_PA7_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PA7_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PA7
// $[GPIO_SL_EMLIB_GPIO_INIT_PA7]
#define SL_EMLIB_GPIO_INIT_PA7_PORT              gpioPortA
#define SL_EMLIB_GPIO_INIT_PA7_PIN               7
// [GPIO_SL_EMLIB_GPIO_INIT_PA7]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PA7_CONFIG_H
