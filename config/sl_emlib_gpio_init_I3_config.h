#ifndef SL_EMLIB_GPIO_INIT_I3_CONFIG_H
#define SL_EMLIB_GPIO_INIT_I3_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_I3_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_I3_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_I3_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_I3_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_I3
// $[GPIO_SL_EMLIB_GPIO_INIT_I3]
#define SL_EMLIB_GPIO_INIT_I3_PORT               gpioPortI
#define SL_EMLIB_GPIO_INIT_I3_PIN                3
// [GPIO_SL_EMLIB_GPIO_INIT_I3]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_I3_CONFIG_H
