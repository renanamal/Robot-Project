#ifndef SL_EMLIB_GPIO_INIT_PA9_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PA9_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PA9_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PA9_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PA9_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PA9_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PA9
// $[GPIO_SL_EMLIB_GPIO_INIT_PA9]
#define SL_EMLIB_GPIO_INIT_PA9_PORT              gpioPortA
#define SL_EMLIB_GPIO_INIT_PA9_PIN               9
// [GPIO_SL_EMLIB_GPIO_INIT_PA9]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PA9_CONFIG_H
