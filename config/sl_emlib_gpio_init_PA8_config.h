#ifndef SL_EMLIB_GPIO_INIT_PA8_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PA8_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PA8_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PA8_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PA8_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PA8_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PA8
// $[GPIO_SL_EMLIB_GPIO_INIT_PA8]
#define SL_EMLIB_GPIO_INIT_PA8_PORT              gpioPortA
#define SL_EMLIB_GPIO_INIT_PA8_PIN               8
// [GPIO_SL_EMLIB_GPIO_INIT_PA8]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PA8_CONFIG_H
