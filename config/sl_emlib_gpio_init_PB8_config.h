#ifndef SL_EMLIB_GPIO_INIT_PB8_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PB8_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PB8_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PB8_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PB8_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PB8_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PB8
// $[GPIO_SL_EMLIB_GPIO_INIT_PB8]
#define SL_EMLIB_GPIO_INIT_PB8_PORT              gpioPortB
#define SL_EMLIB_GPIO_INIT_PB8_PIN               8
// [GPIO_SL_EMLIB_GPIO_INIT_PB8]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PB8_CONFIG_H
