#ifndef SL_EMLIB_GPIO_INIT_PC5_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PC5_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PC5_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PC5_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PC5_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PC5_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PC5
// $[GPIO_SL_EMLIB_GPIO_INIT_PC5]
#define SL_EMLIB_GPIO_INIT_PC5_PORT              gpioPortC
#define SL_EMLIB_GPIO_INIT_PC5_PIN               5
// [GPIO_SL_EMLIB_GPIO_INIT_PC5]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PC5_CONFIG_H
