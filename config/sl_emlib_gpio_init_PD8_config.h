#ifndef SL_EMLIB_GPIO_INIT_PD8_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PD8_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PD8_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PD8_MODE        gpioModeInputPullFilter

// <o SL_EMLIB_GPIO_INIT_PD8_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PD8_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PD8
// $[GPIO_SL_EMLIB_GPIO_INIT_PD8]
#define SL_EMLIB_GPIO_INIT_PD8_PORT              gpioPortD
#define SL_EMLIB_GPIO_INIT_PD8_PIN               8
// [GPIO_SL_EMLIB_GPIO_INIT_PD8]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PD8_CONFIG_H
