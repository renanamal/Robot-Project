#ifndef SL_EMLIB_GPIO_INIT_PF9_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PF9_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PF9_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PF9_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PF9_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PF9_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PF9
// $[GPIO_SL_EMLIB_GPIO_INIT_PF9]
#define SL_EMLIB_GPIO_INIT_PF9_PORT              gpioPortF
#define SL_EMLIB_GPIO_INIT_PF9_PIN               9
// [GPIO_SL_EMLIB_GPIO_INIT_PF9]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PF9_CONFIG_H
