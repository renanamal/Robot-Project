#ifndef SL_EMLIB_GPIO_INIT_I1_CONFIG_H
#define SL_EMLIB_GPIO_INIT_I1_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_I1_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_I1_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_I1_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_I1_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_I1
// $[GPIO_SL_EMLIB_GPIO_INIT_I1]
#define SL_EMLIB_GPIO_INIT_I1_PORT               gpioPortI
#define SL_EMLIB_GPIO_INIT_I1_PIN                1
// [GPIO_SL_EMLIB_GPIO_INIT_I1]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_I1_CONFIG_H
