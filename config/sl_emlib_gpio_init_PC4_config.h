#ifndef SL_EMLIB_GPIO_INIT_PC4_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PC4_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PC4_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PC4_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PC4_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PC4_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PC4
// $[GPIO_SL_EMLIB_GPIO_INIT_PC4]
#define SL_EMLIB_GPIO_INIT_PC4_PORT              gpioPortC
#define SL_EMLIB_GPIO_INIT_PC4_PIN               4
// [GPIO_SL_EMLIB_GPIO_INIT_PC4]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PC4_CONFIG_H
