#ifndef SL_EMLIB_GPIO_INIT_I2_CONFIG_H
#define SL_EMLIB_GPIO_INIT_I2_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_I2_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_I2_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_I2_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_I2_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_I2
// $[GPIO_SL_EMLIB_GPIO_INIT_I2]
#define SL_EMLIB_GPIO_INIT_I2_PORT               gpioPortI
#define SL_EMLIB_GPIO_INIT_I2_PIN                2
// [GPIO_SL_EMLIB_GPIO_INIT_I2]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_I2_CONFIG_H
