#ifndef SL_EMLIB_GPIO_INIT_PININIT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PININIT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PININIT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PININIT_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PININIT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PININIT_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PININIT
// $[GPIO_SL_EMLIB_GPIO_INIT_PININIT]
#define SL_EMLIB_GPIO_INIT_PININIT_PORT          gpioPortA
#define SL_EMLIB_GPIO_INIT_PININIT_PIN           6
// [GPIO_SL_EMLIB_GPIO_INIT_PININIT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PININIT_CONFIG_H
