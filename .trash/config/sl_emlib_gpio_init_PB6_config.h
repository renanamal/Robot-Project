#ifndef SL_EMLIB_GPIO_INIT_PB6_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PB6_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PB6_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PB6_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PB6_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PB6_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PB6
// $[GPIO_SL_EMLIB_GPIO_INIT_PB6]
#define SL_EMLIB_GPIO_INIT_PB6_PORT              gpioPortB
#define SL_EMLIB_GPIO_INIT_PB6_PIN               6
// [GPIO_SL_EMLIB_GPIO_INIT_PB6]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PB6_CONFIG_H
