#ifndef SL_EMLIB_GPIO_INIT_PB7_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PB7_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PB7_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PB7_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_PB7_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PB7_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PB7
// $[GPIO_SL_EMLIB_GPIO_INIT_PB7]
#define SL_EMLIB_GPIO_INIT_PB7_PORT              gpioPortB
#define SL_EMLIB_GPIO_INIT_PB7_PIN               7
// [GPIO_SL_EMLIB_GPIO_INIT_PB7]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PB7_CONFIG_H
